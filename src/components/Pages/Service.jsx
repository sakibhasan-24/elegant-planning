    ...
    <div className="w-full shadow-xl bg-gray-200 py-1 px-2 relative rounded-lg">
      ...
      <div className="flex  flex-col">
        ...
        <div className="w-4/5 flex-grow  mx-auto ">
          ...
          <p className="my-4 text-center bg-green-800 px-2 py-1 rounded-md text-white font-bold w-3/4">
            {category}
          </p>
          ...
          {offer && (
            <p className="bg-green-700  w-1/2 whitespace-nowrap text-xs absolute top-2 left-1 text-white px-4 py-2 rounded-md">
              Offer Avaiable
            </p>
          )}
        </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="bg-blue-600 text-gray-200 px-4 py-2 rounded-md font-bold">
